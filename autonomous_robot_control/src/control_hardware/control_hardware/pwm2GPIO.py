...
class PwmSubNode(Node):
    def __init__(self):
        ...
        self.dir_l = DigitalOutputDevice(15)      # Reverse state for left wheel
        self.dir_r = DigitalOutputDevice(19)      # Reverse state for right wheel
    ...
    def listener_callback(self, msg):
        buff = 1.0
        self.dir_l.value =  msg.dir_l
        self.dir_r.value =  msg.dir_r
